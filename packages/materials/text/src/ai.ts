...
export const textAIMaterialDescriptor = {
  ...
  properties: ['content', 'writingMode', 'fontSize', 'fontFamily', 'fontWeight', 'fontStyle', 'color', 'backgroundColor', 'textAlign', 'verticalAlign', 'lineHeight', 'letterSpacing', 'autoWrap', 'overflow', 'prefix', 'suffix', 'borderWidth', 'borderColor', 'borderType'],
