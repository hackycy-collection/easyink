...
9. Add i18n keys for visible labels, titles, material-local inline toolbar text, property labels, reject reasons, and history labels. Prefer `context.t()` and `store.t()` over hardcoded strings.
