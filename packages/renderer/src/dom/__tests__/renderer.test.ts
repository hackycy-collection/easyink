...
describe('dOMRenderer', () => {
  ...
  it('should render text element', () => {
    ...
    const textEl = container.querySelector('[data-material-id="text-1"]')
  ...
  it('should skip hidden elements', () => {
    ...
    expect(container.querySelector('[data-material-id="a"]')).not.toBeNull()
    expect(container.querySelector('[data-material-id="b"]')).toBeNull()
  })
  ...
  it('should render unknown element type as placeholder', () => {
    ...
    const el = container.querySelector('[data-material-id="custom-1"]')
  ...
  it('should apply element style', () => {
    ...
    const el = container.querySelector('[data-material-id="rect-1"]') as HTMLElement
  ...
  it('should apply rotation transform', () => {
    ...
    const el = container.querySelector('[data-material-id="r1"]') as HTMLElement
  ...
  it('should render multiple elements with correct positioning', () => {
    ...
    expect(container.querySelector('[data-material-id="e1"]')).not.toBeNull()
    expect(container.querySelector('[data-material-id="e2"]')).not.toBeNull()
    expect(container.querySelector('[data-material-id="e3"]')).not.toBeNull()
  })
  ...
  it('should render image element', () => {
    ...
    const imgWrapper = container.querySelector('[data-material-id="img-1"]')
